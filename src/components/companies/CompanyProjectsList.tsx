...
export const CompanyProjectsList: React.FC<CompanyProjectsListProps> = ({ projects }) => {
      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center gap-3">
          <div className={cn(
            ...
            (project.avancement || 0) === 100 ? "bg-emerald-50 text-emerald-600" : "bg-amber-50 text-amber-600"
          )}>
            <FileText size={18} />
          </div>
  ...
  return (
    <div className="bg-amber-50/30 p-6 rounded-b-2xl border-t border-amber-100/50 animate-in slide-in-from-top-2 duration-300 space-y-8">
      {/* Section En cours */}
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <Clock size={18} className="text-amber-500" />
          <h4 className="text-sm font-bold text-amber-900 uppercase tracking-wider">Projets En cours</h4>
