...
export const ViewModeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [viewModes, setViewModes] = useState<ViewMode[]>(() => {
    ...
    const defaultTrackingModes = [
      { id: "t-default", category: "tracking", name: "Vue Technique", columns: ["reference_projet", "nom_projet", "responsable_interne", "phase", "indice", "etat_mo", "etat_bc", "etat_interne", "etat_global", "avancement", "entreprise_travaux", "derniere_visite", "avancement_travaux"] },
      ...
      { id: "t-etude", category: "tracking", name: "Mode Étude", columns: ["reference_projet", "nom_projet", "responsable_interne", "phase", "indice", "etat_mo", "etat_bc", "etat_interne", "etat_global", "avancement"] },
